...
st.write(
    CareerMate는 사용자의 직업과 위치에 맞춘 뉴스, 트렌드, 이벤트, 정보를 제공하는 맞춤형 챗봇입니다.
    매일 아침 /brief 명령어를 통해 개인화된 브리핑을 받을 수 있으며, 전문 분야에 대한 설명과 피드백까지 
    지원해 실질적인 커리어 성장을 돕습니다.
    "이것은 OpenAI의 GPT-4o 모델을 사용하여 응답을 생성하는 간단한 챗봇입니다."
